...
export default function Step1({ data, handleUserData, handleStep, error }) {
  ...
  return (
    <div className="flex justify-between sm:flex-col">
      <div className="w-4/12 xxl:w-5/12 sm:w-10/12 mb-16">
      ...
      <form className="w-[53.2%] sm:w-full" onSubmit={handleSubmit}>
        <input
          ...
          className="border rounded-[5px] autofill:text-2xl w-full border-inputs py-[3.4%] px-[6.6%] sm:py-3 sm:px-6 placeholder-loginSection text-2xl sm:text-2xl-sm leading-2xl sm:leading-2xl-sm"
        />
        <p>{error}</p>
